        ...
        recipeDetails = (
          <RecipeContainer>
            <CardContainer>
              ...
              <FoodDetails>
                <Detail>
                  <span style={{ fontWeight: 400 }}>Servings:</span>
                  <br></br>
                  {this.props.recipelist[key].servings}
                </Detail>
                <Detail>
                  <span style={{ fontWeight: 400 }}>Prep Time:</span>
                  <br></br>
                  {this.props.recipelist[key].min}
                </Detail>
                <Detail>
                  <span style={{ fontWeight: 400 }}>Cooking:</span>
                  <br></br> {this.props.recipelist[key].cooking}
                </Detail>
                <Detail>
                  <span style={{ fontWeight: 400 }}>Calories:</span>
                  <br></br> {this.props.recipelist[key].calories}
                </Detail>
              </FoodDetails>
            </CardContainer>
            ...
            <DirectionsOl>
              <DirectionsLi>
                In a Dutch oven, heat oil over medium heat until hot, but not
                smoking. Pat the meat dry with paper towels and brown in
                batches, transferring the meat with a slotted spoon to a bowl as
                they are done.
              </DirectionsLi>
              <DirectionsLi>
                In the fat remaining in the pot, cook the onions until softened,
                about 5 minutes.
              </DirectionsLi>
              <DirectionsLi>
                Return meat to the pot with any juices in the bowl and add the
                tomatoes with juice, chiles, beer, beef broth, oregano, cumin,
                and Worcestershire sauce. Season with salt and pepper to taste.
              </DirectionsLi>
              <DirectionsLi>
                Bring to a boil and reduce heat. Simmer, partially covered, for
